...
| AG-TC-003  | GET   /airports             | Retrive airports               | List of airports returned   |
| AG-TC-004  | GET   /airports:id          | Retrive airport by ID          | 200 aport returned          |
...
| AG-TC-010  | GET   /airports?page        | get airports paginationed      | 200 returned                |
